...
def plot_distributions():
    ...
    fig = plt.figure()
    plt.hist(bubble_density, histtype="step", bins=logbins, weights=np.ones_like(bubble_density) / len(bubble_density), label="")
    plt.xscale("log")
    ...
    plt.savefig("Project Summary/CSM_plots/Bubble density.pdf")
